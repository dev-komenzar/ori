...
#
# 旧 npm package は APM bundle (.apm/skills/ori-arch/adapters/) に embed され publish 停止。
...
MESSAGE_ESLINT="Now bundled into .apm/skills/ori-arch/adapters/eslint via APM (v0.3-J). Use 'apm install dev-komenzar/ori' instead. See https://github.com/dev-komenzar/ori"
MESSAGE_RUST="Now bundled into .apm/skills/ori-arch/adapters/rust via APM (v0.3-J). Use 'apm install dev-komenzar/ori' instead. See https://github.com/dev-komenzar/ori"
MESSAGE_GENERIC="Now bundled into .apm/skills/ori-arch/adapters/generic via APM (v0.3-J). Use 'apm install dev-komenzar/ori' instead. See https://github.com/dev-komenzar/ori"
