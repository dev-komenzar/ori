...
# config array; `/ori-arch` (scripts/export.js --adapter=eslint) will overwrite it.
...
// Run `/ori-arch` → scripts/export.js --adapter=eslint to overwrite this file from
