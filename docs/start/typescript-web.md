...
- `/ori-arch` （ステップ 3） — **architect-expert agent** (`.apm/agents/architect-expert.agent.md`)
...
主要ルール (architect-expert agent が生成する `.ori/architecture.md` に
...
- [`.apm/agents/architect-expert.agent.md`](../../.apm/agents/architect-expert.agent.md) — architecture.md 生成 agent (invariants / guardrails / questions / generation_procedure)
