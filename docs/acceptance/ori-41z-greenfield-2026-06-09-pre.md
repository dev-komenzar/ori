...
| 参照すべき example-slice | `apm_modules/dev-komenzar/ori/.apm/contexts/patterns/ddd-vsa-hex/stacks/typescript/example-slice/task-management/slices/complete-task/` |
